...
public class IdentityPortugueseMessagesExtension : IdentityErrorDescriber
{
    ...
    {
        return new IdentityError { Code = nameof(InvalidEmail), Description = $"E-mail '{email}' é inválido." };
    }
    ...
    {
        return new IdentityError
            { Code = nameof(DuplicateEmail), Description = $"E-mail '{email}' já está sendo utilizado." };
    }
