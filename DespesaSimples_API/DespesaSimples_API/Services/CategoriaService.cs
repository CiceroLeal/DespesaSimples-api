...
public class CategoriaService(ICategoriaRepository categoriaRepository, ITransacaoRepository transacaoRepository)
    : ICategoriaService
{
    ...
    public async Task<bool> AtualizarCategoriaAsync(string id, CategoriaFormDto categoriaFormDto)
    {
        ...
        await transacaoRepository.AtualizarDiaTransacoesFuturasPorCategoriaAsync(
            idInt ?? 0,
